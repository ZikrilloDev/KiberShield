...
def _run_ciber_mode(term, initial: str | None = None) -> None:
    ...
    # Startup animation is a finite boot sequence.  After it finishes, the
    # command prompt owns the terminal completely: no background renderer is
    # allowed to repaint over command input/output.
    if initial:
